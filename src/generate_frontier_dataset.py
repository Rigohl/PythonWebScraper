...
def generate_dummy_frontier_dataset(
    output_path: str = "data/frontier_dataset.csv", num_samples: int = 100
):
    """
    ...
    print(
        f"Dummy frontier dataset generated at {output_path} with {num_samples} samples."
    )
