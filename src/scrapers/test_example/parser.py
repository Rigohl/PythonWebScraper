...
from typing import Dict, Any    def _extract_price(self, element: Tag) -> Optional[str]:
        """Extrae precio como texto."""
        ...
        if matches and matches[0]:
            try:
                # Tomar el primer número encontrado y mantenerlo como string
                price_str = matches[0].replace(',', '')
                # Verificar que es un número válido
                float(price_str)  # Solo para validación
                return price_str
            except ValueError:
                pass

        return Nonebs4 import BeautifulSoup, Tag
import re
import logging
...
class TestExampleParser:
    ...
    def __init__(self):
        self.selectors = {
            'title': 'h1',  # Selector para título
            'price': '.price',  # Selector para precio
            'description': '.description'  # Selector para descripción
        }
    ...
    def _extract_field(self, soup: BeautifulSoup, field: str, selector: str) -> Optional[str]:
        """Extrae un campo espec�fico usando el selector."""
        element = soup.select_one(selector)

        if not element:
            return None

        # Estrategias de extracci�n espec�ficas por tipo de campo
    ...
    def _post_process_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Post-procesa los datos extra�dos."""
        processed = {}
    ...
    def validate_data(self, data: Dict[str, Any]) -> bool:
        ...
        required_fields = ['title']  # Campos m�nimos requeridos
