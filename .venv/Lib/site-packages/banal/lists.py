...
def chunked_iter(iterable: Iterable[T], batch_size: int = 500) -> Generator[List[T], None, None]:
...
def chunked_iter_sets(iterable: Iterable[T], batch_size: int = 500) -> Generator[Set[T], None, None]:
