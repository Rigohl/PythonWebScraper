...
class Database(object):
    ...
    def create_table(self, table_name, primary_id=None, primary_type=None, primary_increment=None):
        ...
        ::
            ...
            table5 = db.create_table('population5',
                                     primary_id=False)
        """
        assert not isinstance(primary_type, str), "Text-based primary_type support is dropped, use db.types."
        table_name = normalize_table_name(table_name)
        with self.lock:
    ...
    def get_table(
        ...
        return self.create_table(table_name, primary_id, primary_type, primary_increment)
