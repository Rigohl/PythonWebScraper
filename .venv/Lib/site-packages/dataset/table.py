...
class Table(object):
    ...
    def __init__(
        ...
        self._columns = None
        self._indexes = []
        self._primary_id = primary_id if primary_id is not None else self.PRIMARY_DEFAULT
    ...
    def _reflect_table(self):
        ...
        with self.db.lock:
            self._columns = None
            try:
                self._table = SQLATable(self.name, self.db.metadata, schema=self.db.schema, autoload=True)
