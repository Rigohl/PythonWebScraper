...
def outer(x1, x2, /):
    ...
    if x1.ndim != 1 or x2.ndim != 1:
        raise ValueError("Input arrays must be one-dimensional, but they are " f"{x1.ndim=} and {x2.ndim=}.")
...
def svd(a, full_matrices=True, compute_uv=True, hermitian=False):
    ...
    if compute_uv:
        ...
        with errstate(
            call=_raise_linalgerror_svd_nonconvergence, invalid="call", over="ignore", divide="ignore", under="ignore"
        ):
