...
if __NUMPY_SETUP__:
    ...
    def __getattr__(attr):
        ...
        if attr == "linalg":
            ...
            raise AttributeError("`numpy.array_api` is not available from " "numpy 2.0 onwards", name=None)
        elif attr == "core":
            ...
            if "distutils" in __numpy_submodules__:
                ...
                raise AttributeError("`numpy.distutils` is not available from " "Python 3.12 onwards", name=None)
        ...
        if attr in __expired_attributes__:
            raise AttributeError(
                f"`np.{attr}` was removed in the NumPy 2.0 release. " f"{__expired_attributes__[attr]}", name=None
            )
    ...
    def __dir__():
        ...
        public_symbols -= {"matrixlib", "matlib", "tests", "conftest", "version", "distutils", "array_api"}
    ...
    if os.environ.get("NPY_PROMOTION_STATE", "weak") != "weak":
        warnings.warn(
            "NPY_PROMOTION_STATE was a temporary feature for NumPy 2.0 " "transition and is ignored after NumPy 2.2.",
            UserWarning,
            stacklevel=2,
        )
