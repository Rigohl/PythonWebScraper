...
if sys.version_info >= (3, 12):
    ...
    _SupportsBuffer: TypeAlias = bytes | bytearray | memoryview | _array.array[Any] | mmap.mmap | NDArray[Any] | generic
...
class _ArrayOrScalarCommon:
    ...
    def argmax(
        self, /, axis: SupportsIndex | None, out: _BoolOrIntArrayT, *, keepdims: builtins.bool = False
    ) -> _BoolOrIntArrayT: ...
    @overload
    def argmax(
        self, /, axis: SupportsIndex | None = None, *, out: _BoolOrIntArrayT, keepdims: builtins.bool = False
    ) -> _BoolOrIntArrayT: ...
    @overload  # axis=None (default), out=None (default), keepdims=False (default)
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def item(
        self: NDArray[generic[_T]], i0: SupportsIndex | tuple[SupportsIndex, ...] = ..., /, *args: SupportsIndex
    ) -> _T: ...
    ...
    @overload
    def all(
        self, axis: None = None, out: None = None, keepdims: L[False, 0] = False, *, where: _ArrayLikeBool_co = True
    ) -> np.bool: ...
    @overload
    def all(
        self,
