...
class MachArLike:
    ...
    def smallest_subnormal(self):
        ...
        if self.ftype(0) == value:
            warnings.warn(
                f"The value of the smallest subnormal for {self.ftype} type is zero.", UserWarning, stacklevel=2
            )
...
_MACHAR_PARAMS = {
    ...
    ntypes.longdouble: {"itype": ntypes.longlong, "fmt": "%s", "title": _title_fmt.format("long double")},
