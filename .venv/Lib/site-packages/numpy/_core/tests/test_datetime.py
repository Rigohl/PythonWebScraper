...
class TestDateTime:
    ...
    def test_datetime_array_str(self):
        ...
        assert_equal(
            np.array2string(
                a, separator=", ", formatter={"datetime": lambda x: f"'{np.datetime_as_string(x, timezone='UTC')}'"}
            ),
    ...
    def test_creation_overflow(self):
        ...
        for unit in ["ms", "us", "ns"]:
            ...
            assert_equal(timesteps, x[0].astype(np.int64), err_msg=f"Datetime conversion error for unit {unit}")
