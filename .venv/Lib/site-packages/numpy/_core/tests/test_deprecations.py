...
class _DeprecationTestCase:
    ...
    def assert_not_deprecated(self, function, args=(), kwargs={}):
        ...
        """
        self.assert_deprecated(function, num=0, ignore_others=True, exceptions=(), args=args, kwargs=kwargs)
...
class FlatteningConcatenateUnsafeCast(_DeprecationTestCase):
    ...
    def test_deprecated(self):
        self.assert_deprecated(
            np.concatenate, args=(([0.0], [1.0]),), kwargs={"axis": None, "out": np.empty(2, dtype=np.int64)}
        )
    ...
    def test_deprecated(self):
        with temppath(suffix=".npy") as path:
            ...
            for allow_pickle in [True, False]:
                ...
                self.assert_deprecated(
                    np.save, args=sample_args, kwargs={"allow_pickle": allow_pickle, "fix_imports": True}
                )
                self.assert_deprecated(
                    np.save, args=sample_args, kwargs={"allow_pickle": allow_pickle, "fix_imports": False}
                )
...
class TestAddNewdocUFunc(_DeprecationTestCase):
    ...
    def test_deprecated(self):
        self.assert_deprecated(lambda: np._core.umath._add_newdoc_ufunc(struct_ufunc.add_triplet, "new docs"))
