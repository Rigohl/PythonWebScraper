...
class TestMethods:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(30000 * "a" + 100 * "b", 100 * "b", 0, None, 30000, id="30000*a+100*b-100*b-0-None-30000"),
            pytest.param(30000 * "a", 100 * "b", 0, None, -1, id="30000*a-100*b-0-None--1"),
            pytest.param(
                15000 * "a" + 15000 * "b", 15000 * "b", 0, None, 15000, id="15000*a+15000*b-15000*b-0-None-15000"
            ),
            pytest.param(15000 * "a" + 15000 * "b", 15000 * "c", 0, None, -1, id="15000*a+15000*b-15000*c-0-None--1"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(30000 * "a" + 100 * "b", 100 * "b", 0, None, 1, id="30000*a+100*b-100*b-0-None-1"),
            pytest.param(30000 * "a", 100 * "b", 0, None, 0, id="30000*a-100*b-0-None-0"),
            pytest.param(30000 * "a" + 100 * "ab", "ab", 0, None, 100, id="30000*a+100*ab-ab-0-None-100"),
            pytest.param(15000 * "a" + 15000 * "b", 15000 * "b", 0, None, 1, id="15000*a+15000*b-15000*b-0-None-1"),
            pytest.param(15000 * "a" + 15000 * "b", 15000 * "c", 0, None, 0, id="15000*a+15000*b-15000*c-0-None-0"),
            ("", "", 0, None, 1),
            ("", "", 1, 1, 0),
            ("", "", MAX, 0, 0),
            ("", "xx", 0, None, 0),
    ...
    def test_slice_int_type_promotion(self, int_dt, dt):
        ...
        assert_array_equal(
            np.strings.slice(
                buf, np.array([0, 0], dtype=int_dt), np.array([4, 4], dtype=int_dt), np.array([2, 2], dtype=int_dt)
            ),
        ...
        [
            ...
            pytest.param(
                ...
                marks=pytest.mark.xfail(
                    sys.platform == "win32" and IS_PYPY_LT_7_3_16, reason="PYPY bug in Py_UNICODE_ISALNUM", strict=True
                ),
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                True,
                marks=pytest.mark.xfail(
                    sys.platform == "win32" and IS_PYPY_LT_7_3_16, reason="PYPY bug in Py_UNICODE_ISLOWER", strict=True
                ),
            ),
            ("\U0001044E", True),
        ],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                False,
                marks=pytest.mark.xfail(
                    sys.platform == "win32" and IS_PYPY_LT_7_3_16, reason="PYPY bug in Py_UNICODE_ISUPPER", strict=True
                ),
            ),
            ("\U0001044E", False),
        ],
...
class TestReplaceOnArrays:
    ...
    def test_replace_count_and_size(self, dt):
        ...
        assert_array_equal(
            r5, np.array(["01234ABCDE6789" * i for i in range(3)] + ["01234ABCDE6789" + "0123456789" * 2], dtype=dt)
        )
    ...
    def test_replace_broadcasting(self, dt):
        ...
        assert_array_equal(r2, np.array([["1,0,0", "1,1,0", "1,1,1"], ["2,0,0", "2,2,0", "2,2,2"]], dtype=dt))
