...
def _make_options_dict(
    ...
    *legacy* and sanity checks.
    ...
    if legacy is False:
        ...
        warnings.warn(
            "legacy printing option can currently only be '1.13', '1.21', " "'1.25', '2.1', '2.2' or `False`",
            stacklevel=3,
        )
...
class FloatingFormat:
    ...
    def fillFormat(self, data):
        ...
        if data.size != finite_vals.size:
            ...
            self.pad_left = max(
                self.pad_left, len(current_options["nanstr"]) - offset, len(current_options["infstr"]) + neginf - offset
            )
